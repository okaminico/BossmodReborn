...
class NA01PiercingStone1(BossModule module) : Components.StandardChasingAOEs(module, new AOEShapeCircle(4f),
    (uint)AID.NA01PiercingStone1, (uint)AID.NA01PiercingStone2, 5f, 2.5f, 5, icon: (uint)IconID.NA01PiercingStoneChaser, activationDelay: 4.0f)
{
    public override void AddAIHints(int slot, Actor actor, PartyRolesConfig.Assignment assignment, AIHints hints)
    {
        base.AddAIHints(slot, actor, assignment, hints);
...
class NA01PiercingStone2(BossModule module) : Components.StandardChasingAOEs(module, new AOEShapeCircle(4f), (uint)AID.NA01PiercingStone4, (uint)AID.NA01PiercingStone5, 5f, 2.5f, 5, icon: (uint)IconID.NA01PiercingStoneChaser, activationDelay: 4.0f)
{
    public override void AddAIHints(int slot, Actor actor, PartyRolesConfig.Assignment assignment, AIHints hints)
    {
        base.AddAIHints(slot, actor, assignment, hints);
        if (Chasers.Count > 0)
        {
            ...
            hints.AddForbiddenZone(ShapeDistance.InvertedCircle(new WPos(0f, 0f), 10));
        }
    }
}
...
class NA02RogueWave(BossModule module) : Components.SimpleKnockbacks(module, (uint)AID.NA02RogueWave1, 15f, shape: new AOEShapeCircle(25f))
{
    public override void AddAIHints(int slot, Actor actor, PartyRolesConfig.Assignment assignment, AIHints hints)
    {
        ...
        if (Casters.Count > 0)
        {
            ...
            {
                hints.AddForbiddenZone(ShapeDistance.InvertedCircle(caster.Origin, 3));
            }
        }
    }
}
...
class NA02RogueWave2(BossModule module) : Components.SimpleKnockbacks(module, (uint)AID.NA02RogueWave3, 15f, shape: new AOEShapeCircle(25f))
{
    public override void AddAIHints(int slot, Actor actor, PartyRolesConfig.Assignment assignment, AIHints hints)
    {
        ...
        if (Casters.Count > 0)
        {
            foreach (var caster in Casters)
            {
                hints.AddForbiddenZone(ShapeDistance.InvertedCone(caster.Origin, 3f, 90.Degrees(), 40.Degrees()));
            }
        }
    }
}
...
class NA02UpwellKnockback(BossModule module) : Components.SimpleKnockbacks(module, (uint)AID.NA02Upwell1, 20f)
{
    public override void AddAIHints(int slot, Actor actor, PartyRolesConfig.Assignment assignment, AIHints hints)
    {
        ...
        if (Casters.Count > 0)
        {
            foreach (var caster in Casters)
            {
                hints.AddForbiddenZone(ShapeDistance.InvertedCone(caster.Origin, 8, 270.Degrees(), 30.Degrees()));
            }
        }
    }
}
...
class NA03TetherIntercept(BossModule module) : BossComponent(module)
{
    ...
    public override void AddAIHints(int slot, Actor actor, PartyRolesConfig.Assignment assignment, AIHints hints)
    {
        ...
        if (Active)
        {
            ...
            hints.AddForbiddenZone(ShapeDistance.InvertedRect(Arena.Center - distance.Scaled(0.5f), distance.ToAngle(), halfLength, halfLength, 1f));
        }
    }
